...
// Here you define the labels and settings of your user interface
// See more at https://apidocs.inbenta.io/chatbot/sdk/configuration
...
window.onload = function() {
  ...
  */
  authenticateCall(initBotSDK);
  // x-inbenta-token, x-inbenta-key added to document.cookies
}

function initBotSDK(inbenta_token, inbenta_key) {
